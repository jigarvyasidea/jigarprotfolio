    ...
    <div name='about' className='  min-h-screen pb-20 bg-gradient-to-bl from-gray-800 to-black text-white'>
      <div className='w-11/12 mx-auto relative '>
        <div className='pt-10 pl-4'>
          ...
          <p className='py-4 text-gray-400 text-xl font-semibold '>If my skills and vibe resonate with you, here's a glimpse into who I am. </p>
        </div>

        <div className='ml-10 mr-4 mt-10 flex flex-col gap-6'>
          <p className='text-gray-400 text-lg  tracking-tighter  text-justify '>I am a dedicated Full Stack Developer with over two years of hands-on experience specializing
          ...
          <div className='flex flex-col gap-1   '>
            <p className='text-gray-400 text-lg tracking-tighter  text-justify '>Frontend Development: Proficient in React.js, HTML, CSS, and JavaScript, creating dynamic and responsive user interfaces.</p>
          ...
          <p className='text-gray-400 text-lg  tracking-tighter  text-justify  '>What sets me apart is my relentless drive to master new skills and my unwavering determination to overcome challenges. While I may take a methodical approach to problem-solving, my deep understanding of concepts ensures that I deliver robust and scalable solutions.</p>
          <p className='text-gray-400 text-lg   tracking-tight  text-justify '>I thrive in environments where I can continuously learn and contribute, and I am eager to bring my strong work ethic and technical skills to a dynamic team. I am particularly passionate about leveraging my abilities to build impactful web applications that solve real-world problems.</p>
        </div>
